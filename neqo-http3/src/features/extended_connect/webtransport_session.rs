...
pub struct Session {
    ...
    /// draining the application is notified via
    /// [`crate::client_events::WebTransportEvent::Draining`] instead.
    /// Will also be set for GOAWAY once `WT_DRAIN_SESSION` handling is
